...
login_btn=PhotoImage(file=r"login\button_login.png")

login_label=Label(image=login_btn)

reg_btn=PhotoImage(file=r"login\button_register.png")
...
Button(win, image=reg_btn,borderwidth=0,bg='#06002e').place(x=360, y=340)  # register button
